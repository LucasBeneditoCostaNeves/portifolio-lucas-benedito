...
Defines the requirements for reusable Framer Motion animation wrappers that allow Server Components to animate their children without needing 'use client' themselves.
