...
O sistema SHALL renderizar os links `sobre`, `skills`, `experiência`, `formação` como lista `<ul>/<li>/<a>` em JetBrains Mono, com hover que adiciona `· ` em accent na frente do texto.
